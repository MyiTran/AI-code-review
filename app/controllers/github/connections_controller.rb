  ...
  class ConnectionsController < ApplicationController
    def create
      ...
      if has_access
        ...
        redirect_to repository_path(repository), notice: 'Repository connected successfully.'
      else
        session[:github_return_repository_id] = repository.id

        redirect_to Github::GetInstallationSettingsUrlService.call(repository.github_installation),
